...
class ProdutosSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('produtos')->insert([
            ...
            Lubrificante composto de óleo mineral multiviscoso e componentes sintéticos de elevado desempenho, 
            para aplicação em motores a gasolina, etanol, Flex e adaptados para uso de GNV. Atende nível de desempenho 
            API SL. Pode ser usado em substituição aos lubrificantes de nível API SF, SG, SH e SJ. Disponível no grau 
            SAE 10w40.
            
            Composição Química: Óleo mineral, base sintética tipo III, anti corrosivo, anti desgaste, anti espumante, 
            anti oxidante, detergente, dispersante, agente de reserva alcalina, melhorador do índice de viscosidade e 
            abaixador do ponto de fluidez.',
            //'valor' => 999.99,
            'imagem' => 'images/Produtos/BASIC-10W40-SL.jpg',
            'categoria_id' => 1,
            'ficha' => 'fichas/ESP-Max2-Turbo-15W40-CH-4.pdf',
            'fispq' => 'fichas/FISPQ-Dulub-Max3-Turbo-15W40-CI-4.pdf'
        ]);
        ...
        DB::table('produtos')->insert([
            ...
            'descricao' => '• GASOLINA, ETANOL E GNV
            Óleo lubrificante mineral multiviscoso de desempenho superior para uso em modernos motores a gasolina, 
            etanol, flex e GNV. Atende nível de desempenho API SL. Pode ser usado em substituição aos óleos com nível 
        ...
        DB::table('produtos')->insert([
            ...
            'descricao' => '• GASOLINA, ETANOL E GNV
            Óleo lubrificante mineral multiviscoso de última geração utilizado em modernos motoresdos automóveis atuais. 
        ...
        DB::table('produtos')->insert([
            ...
            'descricao' => '• GASOLINA, ETANOL, FLEX E GNV
            Lubrificante semissintético para motores a gasolina, etanol, flex e GNV. É recomendado para uso em motores de alta 
        ...
        DB::table('produtos')->insert([
            ...
            'descricao' => '• GASOLINA, ETANOL, FLEX E GNV
            Lubrificante semissintético para motores a gasolina, etanol, flex e GNV. É recomendado para uso em motores de 
        ...
        DB::table('produtos')->insert([
            ...
            'descricao' => '• GASOLINA, ETANOL, FLEX E GNV
            Lubrificante 100% sintético de última geração para motores a gasolina, etanol, flex e GNV. É recomendado para 
        ...
        DB::table('produtos')->insert([
            ...
            'descricao' => '• GASOLINA, ETANOL, FLEX E GNV
            Lubrificante 100% sintético de última geração para motores a gasolina, etanol, flex e GNV. 
        ...
        DB::table('produtos')->insert([
            ...
            'descricao' => '• MOTOR DIESEL
            Óleo de base mineral multiviscoso para motores diesel turbo alimentado e/ou motores de alta potência de todas as marcas.
        ...
        DB::table('produtos')->insert([
            ...
            'descricao' => '• MOTOR DIESEL
            Lubrificante semissintético multiviscoso para motores diesel turbinados que operam em condições extremas 
        ...
        DB::table('produtos')->insert([
            ...
            'descricao' => '• MOTOR DIESEL
            Lubrificante mineral multiviscoso para motores diesel turbinados que operam em condições extremas de 
        ...
        DB::table('produtos')->insert([
            ...
            'descricao' => '• MOTOR DIESEL
            Óleo lubrificante mineral de última geração para motores diesel turbinados de alta performance e de baixas 
        ...
        DB::table('produtos')->insert([
            ...
            Dulub Moto 4T Extreme é um lubrificante de base mineral de avançada tecnologia para uso em motores de 
        ...
        DB::table('produtos')->insert([
            'nome' => 'MOTO 2T',
            'descricao' => '• MOTOCICLETAS
            Óleo mineral para motores a gasolina de 2 tempos de superior desempenho. Indicado  para  motocicletas,  ciclomotores  e  cortadores  de  grama.
        ...
        DB::table('produtos')->insert([
            ...
            Fluido adequado para a maioria dos sistemas de transmissões automáticos, direções hidráulicas e sistemas 
        ...
        DB::table('produtos')->insert([
            ...
            'descricao' => '• TRANSMISSÃO
            Óleo para lubrificação de diferenciais hipoidais, alguns tipos de caixas de mudanças manuais, 
