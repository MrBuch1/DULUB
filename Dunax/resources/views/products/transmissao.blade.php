...
<div class="container-narrow">
    <img class="img-responsive img-fluid mb-5 shadow-lg" src="..\images\bg-transmissao.jpg" alt="" style="width:100%; margin-top:-600px; filter:brightness(50%);">
</div>

<div class="container">
    <h1 style="text-decoration:underline" align="center"><strong>LINHA TRANSMISSÃO</strong></h1>
</div>
