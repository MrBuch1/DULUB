...
<div class="container-narrow">
    <img class="img-responsive img-fluid mb-5 shadow-lg" src="..\images\aquecedor.jpg" alt="" style="width:100%; margin-top:-260px; filter:brightness(50%);">
</div>

<div class="container">
    <h1 style="text-decoration:underline" align="center"><strong>LINHA TÉRMICOS</strong></h1>
</div>
