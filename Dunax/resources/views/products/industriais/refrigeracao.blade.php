...
<div class="container-narrow">
    <img class="img-responsive img-fluid mb-5 shadow-lg" src="..\images\refrigeracao.jpg" alt="" style="width:100%; margin-top:-520px; filter:brightness(50%);">
</div>

<div class="container">
    <h1 style="text-decoration:underline" align="center"><strong>LINHA REFRIGERAÇÃO</strong></h1>
</div>
