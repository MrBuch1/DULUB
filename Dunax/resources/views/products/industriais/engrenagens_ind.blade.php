...
<div class="container-narrow">
    <img class="img-responsive img-fluid mb-5 shadow-lg" src="..\images\engrenagens.jpg" alt="" style="width:100%; margin-top:-450px; filter:brightness(50%);">
</div>

<div class="container">
    <h1 style="text-decoration:underline" align="center"><strong>LINHA ENGRENAGENS INDUSTRIAIS</strong></h1>
</div>
