...
<div class="container-narrow">
    <img class="img-responsive img-fluid mb-5 shadow-lg" src="..\images\desmoldantes.jpg" alt="" style="width:100%; margin-top:-240px; filter:brightness(50%);">
</div>

<div class="container">
    <h1 style="text-decoration:underline" align="center"><strong>LINHA DESMOLDANTES</strong></h1>
</div>
