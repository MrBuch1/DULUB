...
<div class="container-narrow">
    <img class="img-responsive img-fluid mb-5 shadow-lg" src="..\images\caixa_marcha.jpg" alt="" style="width:100%; margin-top:-415px; filter:brightness(50%);">
</div>

<div class="container">
    <h1 style="text-decoration:underline" align="center"><strong>LINHA ENGRENAGENS</strong></h1>
</div>
